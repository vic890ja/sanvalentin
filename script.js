...
document.getElementById('siBtn').addEventListener('click', function() {
     // Cambiar el fondo del cuerpo a la nueva imagen
     document.body.style.backgroundImage = "url('imagen7.jpg')";
    ...
    document.getElementById('messageContainer').innerHTML = '¡Siii! Preparate para el pikiniki';
